...
SCOPE_FIXTURE_CTOR(autoPatternTest1633, STest, STest("a|b|ca")) {
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(4, 5, 0), fixture.Hits[4]);
  SCOPE_ASSERT_EQUAL(SearchHit(5, 6, 0), fixture.Hits[5]);
  SCOPE_ASSERT_EQUAL(SearchHit(6, 8, 0), fixture.Hits[6]);
  SCOPE_ASSERT_EQUAL(SearchHit(8, 9, 0), fixture.Hits[7]);
  SCOPE_ASSERT_EQUAL(SearchHit(9, 10, 0), fixture.Hits[8]);
  SCOPE_ASSERT_EQUAL(SearchHit(10, 11, 0), fixture.Hits[9]);
  SCOPE_ASSERT_EQUAL(SearchHit(11, 12, 0), fixture.Hits[10]);
  SCOPE_ASSERT_EQUAL(SearchHit(12, 14, 0), fixture.Hits[11]);
  SCOPE_ASSERT_EQUAL(SearchHit(15, 16, 0), fixture.Hits[12]);
  SCOPE_ASSERT_EQUAL(SearchHit(16, 17, 0), fixture.Hits[13]);
  SCOPE_ASSERT_EQUAL(SearchHit(19, 20, 0), fixture.Hits[14]);
  SCOPE_ASSERT_EQUAL(SearchHit(20, 21, 0), fixture.Hits[15]);
  SCOPE_ASSERT_EQUAL(SearchHit(21, 22, 0), fixture.Hits[16]);
  SCOPE_ASSERT_EQUAL(SearchHit(23, 24, 0), fixture.Hits[17]);
  SCOPE_ASSERT_EQUAL(SearchHit(26, 28, 0), fixture.Hits[18]);
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1638, STest, STest("a|b|cb")) {
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(11, 12, 0), fixture.Hits[10]);
  SCOPE_ASSERT_EQUAL(SearchHit(13, 14, 0), fixture.Hits[11]);
  SCOPE_ASSERT_EQUAL(SearchHit(14, 16, 0), fixture.Hits[12]);
  SCOPE_ASSERT_EQUAL(SearchHit(16, 17, 0), fixture.Hits[13]);
  SCOPE_ASSERT_EQUAL(SearchHit(18, 20, 0), fixture.Hits[14]);
  SCOPE_ASSERT_EQUAL(SearchHit(20, 21, 0), fixture.Hits[15]);
  SCOPE_ASSERT_EQUAL(SearchHit(21, 22, 0), fixture.Hits[16]);
  SCOPE_ASSERT_EQUAL(SearchHit(22, 24, 0), fixture.Hits[17]);
  SCOPE_ASSERT_EQUAL(SearchHit(27, 28, 0), fixture.Hits[18]);
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1642, STest, STest("a|b|cc")) {
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(15, 16, 0), fixture.Hits[12]);
  SCOPE_ASSERT_EQUAL(SearchHit(16, 17, 0), fixture.Hits[13]);
  SCOPE_ASSERT_EQUAL(SearchHit(17, 19, 0), fixture.Hits[14]);
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(24, 26, 0), fixture.Hits[19]);
...
SCOPE_FIXTURE_CTOR(autoPatternTest1643, STest, STest("a|b|c.")) {
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(20, 21, 0), fixture.Hits[16]);
  SCOPE_ASSERT_EQUAL(SearchHit(21, 22, 0), fixture.Hits[17]);
  SCOPE_ASSERT_EQUAL(SearchHit(22, 24, 0), fixture.Hits[18]);
  SCOPE_ASSERT_EQUAL(SearchHit(24, 26, 0), fixture.Hits[19]);
  SCOPE_ASSERT_EQUAL(SearchHit(26, 28, 0), fixture.Hits[20]);
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1645, STest, STest(R"(a|a|a*)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1646, STest, STest(R"(a|a|a?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1648, STest, STest(R"(a|a|a*?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1649, STest, STest(R"(a|a|a??)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1650, STest, STest(R"(a|a|a{0,1})")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1654, STest, STest(R"(a|a|a{0,1}?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1659, STest, STest(R"(a|b|a*)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1660, STest, STest(R"(a|b|a?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1662, STest, STest(R"(a|b|a*?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1663, STest, STest(R"(a|b|a??)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1664, STest, STest(R"(a|b|a{0,1})")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1668, STest, STest(R"(a|b|a{0,1}?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1673, STest, STest(R"(a|a|b*)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1674, STest, STest(R"(a|a|b?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1676, STest, STest(R"(a|a|b*?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1677, STest, STest(R"(a|a|b??)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1678, STest, STest(R"(a|a|b{0,1})")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1682, STest, STest(R"(a|a|b{0,1}?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1687, STest, STest(R"(a|b|b*)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1688, STest, STest(R"(a|b|b?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1690, STest, STest(R"(a|b|b*?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1691, STest, STest(R"(a|b|b??)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1692, STest, STest(R"(a|b|b{0,1})")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1696, STest, STest(R"(a|b|b{0,1}?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1700, STest, STest("a|b|c+")) {
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(15, 16, 0), fixture.Hits[15]);
  SCOPE_ASSERT_EQUAL(SearchHit(16, 17, 0), fixture.Hits[16]);
  SCOPE_ASSERT_EQUAL(SearchHit(17, 19, 0), fixture.Hits[17]);
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(22, 23, 0), fixture.Hits[21]);
  SCOPE_ASSERT_EQUAL(SearchHit(23, 24, 0), fixture.Hits[22]);
  SCOPE_ASSERT_EQUAL(SearchHit(24, 27, 0), fixture.Hits[23]);
  SCOPE_ASSERT_EQUAL(SearchHit(27, 28, 0), fixture.Hits[24]);
}

SCOPE_FIXTURE_CTOR(autoPatternTest1701, STest, STest(R"(a|b|c*)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1702, STest, STest(R"(a|b|c?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1704, STest, STest(R"(a|b|c*?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1705, STest, STest(R"(a|b|c??)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(autoPatternTest1706, STest, STest(R"(a|b|c{0,1})")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
...
SCOPE_FIXTURE_CTOR(autoPatternTest1708, STest, STest("a|b|c{1,2}")) {
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(22, 23, 0), fixture.Hits[21]);
  SCOPE_ASSERT_EQUAL(SearchHit(23, 24, 0), fixture.Hits[22]);
  SCOPE_ASSERT_EQUAL(SearchHit(24, 26, 0), fixture.Hits[23]);
...
SCOPE_FIXTURE_CTOR(autoPatternTest1709, STest, STest("a|b|c{2,}")) {
  ...
  SCOPE_ASSERT_EQUAL(SearchHit(21, 22, 0), fixture.Hits[17]);
  SCOPE_ASSERT_EQUAL(SearchHit(23, 24, 0), fixture.Hits[18]);
  SCOPE_ASSERT_EQUAL(SearchHit(24, 27, 0), fixture.Hits[19]);
  SCOPE_ASSERT_EQUAL(SearchHit(27, 28, 0), fixture.Hits[20]);
}

SCOPE_FIXTURE_CTOR(autoPatternTest1710, STest, STest(R"(a|b|c{0,1}?)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}
