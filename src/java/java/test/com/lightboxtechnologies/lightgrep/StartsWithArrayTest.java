...
public class StartsWithArrayTest extends BaseStartsWithTest {
  ...
  public static Collection<Object[]> data() throws UnsupportedEncodingException {
    ...
    l.add(
      new Object[]{ 0, 0, new Pat[]{ new Pat("a+b", new KeyOptions(), new String[]{ "ASCII" }) }, new ProgramOptions(), new ContextOptions(), aaab, -1, aaab.length, 0, 0, new SearchHit[0], IndexOutOfBoundsException.class }
    );
    return l;
  }

  public StartsWithArrayTest(int fsmSizeHint, int pmapSizeHint, Pat[] pats, ProgramOptions popts, ContextOptions copts, byte[] buf, int offset, int size, long startOffset, long endOffset, SearchHit[] ehits, Class<? extends Throwable> tclass) {
