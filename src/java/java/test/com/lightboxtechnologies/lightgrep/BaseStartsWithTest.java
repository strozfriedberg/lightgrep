...
public abstract class BaseStartsWithTest extends AbstractSearchTest {
  @Parameters
  public static Collection<Object[]> data() throws UnsupportedEncodingException {
    ...
    return Arrays.asList(new Object[][] {
      ...
      /* Successful Searches */
      { 0, 0, new Pat[]{ new Pat("WMD", new KeyOptions(), new String[]{ "ASCII" }) }, new ProgramOptions(), new ContextOptions(), "Iraq".getBytes("ASCII"), 0, "Iraq".getBytes("ASCII").length, 0, 0, new SearchHit[]{}, null },
      { 0, 0, new Pat[]{ new Pat("a+b", new KeyOptions(), new String[]{ "ASCII" }) }, new ProgramOptions(), new ContextOptions(), aaab, 0, aaab.length, 0, 0, new SearchHit[]{ new SearchHit(0, 4, 0) }, null }
    });
  }

  public BaseStartsWithTest(int fsmSizeHint, int pmapSizeHint, Pat[] pats, ProgramOptions popts, ContextOptions copts, byte[] buf, int offset, int size, long startOffset, long endOffset, SearchHit[] ehits, Class<? extends Throwable> tclass) {
